(* OASIS_START *)
(* DO NOT EDIT (digest: 02d1b686ef4bb02dcba18e7b27592657) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/Chris00/ANSITerminal";
          synopsis =
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Chris00/ANSITerminal.git";
                      src_repo_browser =
                        Some "https://github.com/Chris00/ANSITerminal";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "Zm\238-\022\218\238*\237V\204W&x\194>";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
